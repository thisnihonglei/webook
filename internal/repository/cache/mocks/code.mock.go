...
// MockCodeRedisCache is a mock of CodeRedisCache interface.
type MockCodeRedisCache struct {
	ctrl     *gomock.Controller
	recorder *MockCodeRedisCacheMockRecorder
}

// MockCodeRedisCacheMockRecorder is the mock recorder for MockCodeRedisCache.
type MockCodeRedisCacheMockRecorder struct {
	mock *MockCodeRedisCache
}

// NewMockCodeRedisCache creates a new mock instance.
func NewMockCodeRedisCache(ctrl *gomock.Controller) *MockCodeRedisCache {
	mock := &MockCodeRedisCache{ctrl: ctrl}
	mock.recorder = &MockCodeRedisCacheMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCodeRedisCache) EXPECT() *MockCodeRedisCacheMockRecorder {
	return m.recorder
}

// Set mocks base method.
func (m *MockCodeRedisCache) Set(ctx context.Context, biz, phone, code string) error {
	m.ctrl.T.Helper()
...
func (mr *MockCodeRedisCacheMockRecorder) Set(ctx, biz, phone, code any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockCodeRedisCache)(nil).Set), ctx, biz, phone, code)
}

// Verify mocks base method.
func (m *MockCodeRedisCache) Verify(ctx context.Context, biz, phone, code string) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCodeRedisCacheMockRecorder) Verify(ctx, biz, phone, code any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Verify", reflect.TypeOf((*MockCodeRedisCache)(nil).Verify), ctx, biz, phone, code)
}
